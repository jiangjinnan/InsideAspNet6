...
namespace App
{
    public static class CatExtensions
    {
        ...
        public static T? GetService<T>(this Cat cat) where T : class => (T?)cat.GetService(typeof(T));
        public static IEnumerable<T> GetServices<T>(this Cat cat) => cat.GetService<IEnumerable<T>>()??Array.Empty<T>();
